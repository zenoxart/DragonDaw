        ...
        switch (vm.ActiveTool)
        {
            case PianoRollTool.Draw:
                if (hit != null)
                {
                    ...
                    else
                    {
                        ...
                        _dragNoteOrigStart = hit.StartTick;
                        _dragNoteOrigLen   = hit.Length;
                        vm.FirePreviewStart(hit.Pitch);   // hear the note's pitch
                    }
                }
                else
                {
                    ...
                    vm.FirePreviewStart(pitch);           // hear the new note's pitch
                }
                break;
            ...
            case PianoRollTool.Select:
                if (hit != null)
                {
                    ...
                    _dragNoteOrigStart = hit.StartTick;
                    _dragNoteOrigLen   = hit.Length;
                    if (hit.IsSelected) vm.FirePreviewStart(hit.Pitch);   // pitched preview on pick
                }
                else
                {
                    if (!shift) vm.DeselectAll();
