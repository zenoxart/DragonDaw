...
public class Track : INotifyPropertyChanged, IDisposable
{
    ...
    private Audio.MeteringSampleProvider? _metering;
    private Audio.MeteringSampleProvider? _busMeter;
    ...
    private void LoadAudio()
    {
        ...
        try
        {
            ...
            _metering = new Audio.MeteringSampleProvider(_volumePan);
    ...
    /// </summary>
    public void SetBusMeter(Audio.MeteringSampleProvider? busMeter)
    {
        _busMeter = busMeter;
    }
    ...
    private void MeterTimer_Tick(object? sender, EventArgs e)
    {
        ...
        var activeMeter = (Audio.MeteringSampleProvider?)_busMeter ?? _metering;
